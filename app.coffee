...
$ ->
	...
	app.optimizedSlab.optimizeSwipe(0,1)
...
((app, context) ->
	...
	class context.OptimizedSlab
		...
		optimizeSwipe: (indexOfFirstItem, pageSize) =>
			...
			#console.log "render: ", $('#offscreen li').slice(indexOfFirstItem, totalElementsToRender)
			console.log "element: ", $('#offscreen ul li').first()
			@renderSlab($('#offscreen ul li').first(), textHeight)
			...
			# for el in $('#offscreen li').slice(indexOfFirstItem, totalElementsToRender)
			# 	# console.log "rendering : ", el
			# 	# console.log "textHeight: ", textHeight
			# 	if el
			# 		@renderSlab(el, textHeight)
